                            ...
                            <div class="col-lg-4">
                              <div class="card mb-4">
                                <div class="card-body text-center">
                                  <img src="profileAdmin/image/<?php echo $image?>" alt="avatar"
                                    class="rounded-circle img-fluid" style="width: 124px;">
                                  <h5 class="my-3"><?php echo $name ?></h5>
                                  <p class="text-muted mb-1">MTA Admin</p>
                                  <p class="text-muted mb-4"><?php echo $city.", ".$state.", ".$country ?></p>
                                  <div class="d-flex justify-content-center mb-2">
                                    <button type="button" class="btn btn-primary" onclick="window.location.href='profileAdmin/admin_profile.php'">Edit Profile</button>
                                  </div>
                                </div>
                              </div>
