                      ...
                      <div class="card-body">
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover">
                            <thead>
                                <tr>
                                    <a href="add_event.php"><button style="size: 20px; border-radius: 10px; width: 100px; height:40px; background-color: rgb(230, 144, 15); color: aliceblue;">Add Event</button></a>
                                </tr>
                                <br><br><tr>
                                <th>No</th>
                                <th>Year</th>
