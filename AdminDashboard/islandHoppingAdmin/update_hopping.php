...
<head>
    ...
    <title>Update Island Hopping</title>
...
if(isset($_POST['btnUpdate'])){
    $id = $_POST['id'];
    // console_log($id);
    $sql="SELECT * FROM `islandhopping` WHERE hopping_ID='$id' ";
...
<!-- ---------------------------------------------------------------------------------------------------------------- -->
                <div class="col-12 grid-margin stretch-card" >
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title" style="color: black;"><b>Update Island Hopping</b></h4>
                        ...
                        <input type="hidden" name="id" value="<?php echo $rows['hopping_ID'];?>">
                          ...
                          <div class="form-group">
                            <label for="UpdatepriceA">Price (Adult)</label>
                            <input type="text" class="form-control" id="UpdatepriceA" name="UpdatepriceA" placeholder="RMXX.XX" style="width: 150px;" value="<?php echo $rows['priceA'];?>">
                          </div>
                          
                          <div class="form-group">
                            <label for="UpdatepriceC">Price (Children)</label>
                            <input type="text" class="form-control" id="UpdatepriceC" name="UpdatepriceC" placeholder="RMXX.XX" style="width: 150px;" value="<?php echo $rows['priceC'];?>">
                          </div>
                          ...
                          <div class="form-group">
                            <label for="Updateisland">Island Included</label>
                            <input type="text" class="form-control" id="Updateisland" name="Updateisland" placeholder="Island" value="<?php echo $rows['islandIncluded'];?>">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="Updateitenerary">Itenerary</label>
                            <input type="text" class="form-control" id="Updateitenerary" name="Updateitenerary" placeholder="Itenerary" value="<?php echo $rows['itenerary'];?>">
                          </div>
