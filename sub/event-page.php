      ...
      <div class="event" id="event1">
        ...
        <div class="event-right">
          ...
          <div class="event-description" style="color: white;">
            <?php echo $row['Main_Description']?><br><br>

            <?php echo $row['Second_Description']?><br><br>
           
          </div>
          <div class="images">
            <?php
            
            $imageURL1 = 'AdminDashboard/eventAdmin/image/'.$row["Image1"];
            $imageURL2 = 'AdminDashboard/eventAdmin/image/'.$row["Image2"];
            $imageURL3 = 'AdminDashboard/eventAdmin/image/'.$row["Image3"];
          ...
          <div class="event-timing">
            <img src="images/EVENT/time.png" alt="" /> <?php echo $row['Time']?>
          </div>
        </div>
      </div>
