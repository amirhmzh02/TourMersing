                      ...
                      <div class="card-body">
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover">
                            <thead>
                                <tr>
                                    <a href="add_hopping.php"><button style="size: 20px; border-radius: 10px; width: 200px; height:40px; background-color: rgb(230, 144, 15); color: aliceblue;">Add Island Hopping</a></label>
                                </tr>
                                <br><br><tr>
                                <th>No.</th>
                                <th>Name</th>
          ...
          if(move_uploaded_file($_FILES["image2"]["tmp_name"], $targetFilePath2)){
              ...
              if(move_uploaded_file($_FILES["image3"]["tmp_name"], $targetFilePath3)){
                    ...
                    if(move_uploaded_file($_FILES["image4"]["tmp_name"], $targetFilePath4)){
                                ...
                                $sql="INSERT INTO `islandhopping`(`name`, `price`, `image1`, `image2`, `image3`, `image4`, `islandIncluded`, `packageIncluded`, `phonenum1`, `phonenum2`, `itenerary`) VALUES ('$name','$price','$fileName','$fileName2','$fileName3','$fileName4','$island','$package','$phonenum1','$phonenum2','$itenerary')";
                                $db=$conn->query($sql);
          ...
          if(move_uploaded_file($_FILES["Updateimage2"]["tmp_name"], $targetFilePath2)){
              ...
              if(move_uploaded_file($_FILES["Updateimage3"]["tmp_name"], $targetFilePath3)){
                    ...
                    if(move_uploaded_file($_FILES["Updateimage4"]["tmp_name"], $targetFilePath4)){
                                ...
                                $sql="UPDATE `islandhopping` SET `name`='$name',`price`='$price',`image1`='$fileName',`image2`='$fileName2',`image3`='$fileName3',`image4`='$fileName4',`islandIncluded`='$island',`packageIncluded`='$package',`phonenum1`='$phonenum1',`phonenum2`='$phonenum2' ,`itenerary`='$itenerary'WHERE `hopping_ID`='$id' ";
                                $db=$conn->query($sql);
