...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/booking-pagestyle.css">
                      ...
                      <div class="row">
                          <div class="col-md-6 first-button">
                              <div class="text-button">
                                <a href="/booking/reservation.php">Book Now</a>  
                              </div>
                          </div>
        ...
        <div class="item">
          <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
              <div class="content">
                <span class="info" style="color: #111; font-weight: bold; " >RM140<span style="color:#111; font-weight:normal; font-size: 14px;">/person</span><br>RM70<span style="color:#111; font-weight:normal; font-size: 14px;">/child [5-11yo]</span></span>
                <h4 style="color: #22b3c1" >LIGHT & EASY</h4>
                <div class="row">
                  <div class="col-6">
                ...
                <div class="main-button">
                  <a href="BOOKINGDETAILS/bookingdetails-light&easy.html">VIEW MORE</a>
                </div>
              </div>
            </div>
          </div>
