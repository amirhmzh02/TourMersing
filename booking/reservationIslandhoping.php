...
<body style="background-color:#222;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="https://etourmersing.com" class="logo">
  ...
  <hr>
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <form id="reservation-form" name="gs" method="POST" role="search" action="toyyibPayIsland/request.php">
            <div class="row">
              <div class="col-lg-12">
              ...
              <div class="col-lg-6">
                <fieldset>
                    <label for="package" class="form-label">Choose Your Island Hoping Package</label>
                    <select style="width: 100%;" name="package" id="package" class="form-select" aria-label="Default select example"  onclick="tukar()">
                        <option value="light"selected>LIGHT AND EASY - Day trip 3 Islands</option>
                        <option value="adventure">ADVENTURE - Day trip 5 Islands</option>
                    </select>
                </fieldset>
            </div>
              ...
              <!-- <div class="col-lg-6">
                <fieldset>
                    <label for="checkIn" class="form-label">Date</label>
                    <input style="50%" type="date" id="checkIndate" name="checkIndate" min="2022-10-12" class="date" onchange="date(event)" required>
                </fieldset>
              </div> -->
              ...
              <div class="col-lg-6">
                <fieldset>
                    <label for="chooseGuests" class="form-label">Number of Adult</label>
                    <input type="number" id="Numofadult" name="numofadult" class="date" value="0" onclick="calc(this.value)" min="0" max="12" required>
                    <select style="width: 100%;" name="adult" id="adult" class="form-select" aria-label="Default select example"  onchange="calcIslandSelect(this.value)">
            ...
            <div class="col-lg-6">
                <fieldset>
                    <label for="chooseGuests" class="form-label">Number of Children (5-11 years old)</label>
                    <input type="number" id="Numofchild" name="numofchild" class="date"  value="0" onclick="calc(this.value)" min="0" max="12" required>
                    <select style="width: 100%;" name="child" id="child" class="form-select" aria-label="Default select example"  onchange="calcIslandSelect(this.value)">
                          <option value="0" selected>0</option>
                          <option value="1">1</option>
                          <option value="2">2</option>
                          <option value="3">3</option>
            ...
            <div class="col-lg-6">
                <fieldset>
                    <label for="checkIn" class="form-label">Date<small style="margin-left:10px;">(4 days after payment)</small></label>
                    <input style="50%" type="date" id="date" name="date" min="2022-11-06" class="date" onchange="date(event)" required>
                </fieldset>
              </div>
            ...
            <label for="text" id="total" class="total">Payment method</label>
              ...
              <div class="col-lg-12">    
                ...
                <label for="text" id="lblsubmit" class="submit">*By clicking the submit button below, you will agree to our terms and conditions and <a href="https://etourmersing.com/privacypolicy-page.html" style="text-decoration-line:underline; color:blue;">Privacy Policy</a>.</label>                    
                <fieldset>
  ...
  var date = new Date();
        ...
        var targetDate=String(date.getDate()+4).padStart(2,'0');
        ...
        document.getElementById('date').setAttribute("min", pattern);
  
  function tukar(){
    document.getElementById("Numofchild").value = "0";
    document.getElementById("Numofadult").value = "0";
  ...
  <script>
    function myFunction (x){
      if (x.matches){
        ...
        document.getElementById('Numofadult').style.display="none";
        document.getElementById('Numofchild').style.display="none";
      }
      else{
        document.getElementById("adult").style.display="none";
        document.getElementById("child").style.display="none";
        document.getElementById('Numofadult').style.display="inline-block";
        document.getElementById('Numofchild').style.display="inline-block";
      }
    }
  ...
  <script src="assets/js/islandhop.js"></script>
  <script src="assets/js/islandscriptSelect.js"></script>
  </body>
